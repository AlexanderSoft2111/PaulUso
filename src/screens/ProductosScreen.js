...
// Establecemos la conexion para abrir el Realm
...
export const ProductosScreen = ({navigation,route}) => {
    ...
    //Atrapamos el valor del ID del usuario pasado en la pantalla principal
    ...
    const crearElemento = () =>{
        ...
        //Luego de crear un producto, cargamos los productos para visuzalizar los cambios
        cargarProductos();
    }
   

//Funcion para cerrar la aplicación de real
    const cerrar = () => {

        Realm.close();  
    
        console.log("cerre el realm");
    }
    ...
    return (
        ...
        <Button onPress={cerrar} title='Cerrar'/> 
        </View>
    )
 
}

//Definimos una variable para establecer los estilos
